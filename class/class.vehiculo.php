...
class vehiculo{
	...
	public function get_list(){
		...
		<table border="1" align="center">
			...
			<tr>
				<th colspan="8"><a href="vehiculo.php?d=' . $d_new_final . '">Nuevo</a></th>
			</tr>
			<tr>
				<th>Placa</th>
				<th>Marca</th>
			...
			*/
				...
				$html .= '
					<tr>
						...
						<td>' . $row['anio'] . '</td>
						<td>' . $row['avaluo'] . '</td>
						<td><a href="vehiculo.php?d=' . $d_del_final . '">Borrar</a></td>
						<td><a href="vehiculo.php?d=' . $d_act_final . '">Actualizar</a></td>
						<td><a href="vehiculo.php?d=' . $d_det_final . '">Detalle</a></td>
					</tr>
					';
...
public function get_detail_vehiculo($id){
	...
	public function save_vehiculo(){
		...
		$sql = "INSERT INTO vehiculo VALUES (NULL, '$this->placa',
									$this->marca,
									'$this->motor', 
									'$this->chasis',
									'$this->combustible',
...
//***************************************************************************************************************************
	...
	private function _message_ok($tipo){
		...
		<table border="0" >
			...
			<tr>
				<th><a colspan="8" href="vehiculo.php">Regresar</a></th>
			</tr>
		</table>';
		return $html;
	}
