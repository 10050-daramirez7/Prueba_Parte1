	...
	*/
	...
	public function get_list(){
		...
		<table border="1" align="center">
			...
			<tr>
				<th colspan="8"><a href="marca.php?d=' . $d_new_final . '">Nuevo</a></th>
			</tr>
			<tr>
				<th>descripcion</th>
				<th>pais</th>
		...
		$sql = "SELECT m.id, m.descripcion, m.pais
				FROM marca m;";
        ...
        if($num != 0){
			...
			*/
		    ...
		    $html .= '
					<tr><th colspan="8"><a href="index.php? ">Regresar</a></th></tr>';
		}else{
...
public function get_detail_marca($id){
	...
	public function update_marca(){
		...
		//UPDATE `matriculacionvehicular`.`marca` SET `descripcion`='Hyundai', `pais`='Corea', `direccion`='Seúl' WHERE `id`='5';
	...
	public function save_marca(){
		...
		/*$sql = "INSERT INTO 'marca'('descripcion', 'pais', 'direccion', 'foto') VALUES ('$this->descripcion', '$this->pais', '$this->direccion', '$this->foto';)";
		echo $sql;*/
		if($this->con->query($sql)){
